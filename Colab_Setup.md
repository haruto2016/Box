...
!sudo apt-get update
!DEBIAN_FRONTEND=noninteractive sudo apt-get install -y xfce4 xfce4-terminal tigervnc-standalone-server novnc autocutsel fonts-noto-cjk language-pack-ja yaru-theme-gtk yaru-theme-icon
...
# VNCサーバーの起動 (色深度を16bitに下げることで速度を大幅に向上)
print("Starting Desktop Server (High Speed Mode)...")
